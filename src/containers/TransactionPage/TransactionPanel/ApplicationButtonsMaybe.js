...
// Functional component as a helper to build ApplicationButtons
const ApplicationButtonsMaybe = props => {
  const {
    className,
    rootClassName,
    showButtons,
  ...
  return showButtons ? (
    <div className={classes}>
      ...
      <div className={css.applicationButtonWrapper}>
        {secondaryButton}
        {primaryButton}
      </div>
    </div>
...
export default ApplicationButtonsMaybe;
